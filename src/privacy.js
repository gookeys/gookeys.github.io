...
class Privacy extends React.Component{
    render(){
        return(
            <main>
                <Helmet>
                    <title>Gookeys - Privacy</title>
                </Helmet>
            <div className='banner'>
                <h1>Gookeys Terms of Use</h1>
            </div>
                ...
                <div className='row'>
                    ...
                    <div className='col-lg-12 homcrd'>
                        <div className='col-lg-12 col-sm-12 pagecnt lf'>
                            ...
                            <p>At Gookeys Store, accessible from https://www.gookeys.com/store, one of our main priorities
                                is the privacy of our visitors. This Privacy Policy document contains types of information
                                that is collected and recorded by Gookeys Store and how we use it.</p>
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                                website with regards to the information that they shared and/or collect in Gookeys Store.
                            ...
                            <p>Gookeys Store follows a standard procedure of using log files. These files log visitors when
                            ...
                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                                Beacons that are used in their respective advertisements and links that appear on Gookeys
                                Store, which are sent directly to users' browser. They automatically receive your IP address
                            ...
                            <p>Note that Gookeys Store has no access to or control over these cookies that are used by
                                third-party advertisers.</p>
    
                            <h2>Third Party Privacy Policies</h2>
    
                            <p>Gookeys Store's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                            ...
                            <p>Gookeys Store does not knowingly collect any Personal Identifiable Information from children
