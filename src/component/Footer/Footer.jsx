          ...
          <div className="col-lg-12">
            ...
            <div className="col-lg-3 col-sm-12 lf">
              ...
              <ul>
                ...
                <li>
                  <Link to="/wordpress-services">Wordpress</Link>
                </li>
                <li>
                  <Link to="/domain-web-hosting">Domain Hosting Services</Link>
                </li>
                <li>
                  <Link to="/seo-digital-marketing">SEO & Digital Marketing</Link>
                </li>
              </ul>
            </div>
