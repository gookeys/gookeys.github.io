            ...
            <div className="col-lg-12">
              ...
              <div className="col-lg-12 col-sm-12 pagecnt lf">
                ...
                <p>
                      ...
                      <strong>PSD to HTML</strong> conversions that transform
                      your designs into responsive, functional websites. We
                      ensure that every project we undertake is optimized for
                      performance, user experience (UX), and search engine
                      visibility, helping your business stand out in today’s
